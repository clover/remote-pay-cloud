...
CloverConnectorImpl = Class.create( remotepay.ICloverConnector, {
    ...
    initialize: function(configuration) {
        ...
        if(!this.configuration["applicationId"]) {
            throw new CloverError(CloverError.INCOMPLETE_CONFIGURATION, "'applicationId' must be included in the configuration.");
        }
        ...
        this.messageBuilder = new RemoteMessageBuilder(builderPackageConf,
          ...
          this.configuration.applicationId, messageCount
        );
